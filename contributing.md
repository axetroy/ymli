# Contributing to ymli

First and foremost, thank you! We appreciate that you want to contribute to ymli, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for ymli**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for ymli:

- star the [project](https://github.com/axetroy/ymli)
- tweet your support for ymli
...
- **version**: please note the version of ymli are you using
...
[so]: http://stackoverflow.com/questions/tagged/ymli